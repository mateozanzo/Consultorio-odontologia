...
def menu(perfil):
    opciones = {
        ...
        "paciente": ["1. Ingresar turnos", "2. Ver turnos", "3. Eliminar turnos", "8. Salir"],
        "medico": ["2. Ver turnos asignados","3. Ver agenda diaria" ,"8. Salir"]
    }
...
while True:
    ...
    if perfil_actual == "admin":
        ...
        acciones = [ingresar_turnos, lambda: mostrar_turnos(usuario_actual, perfil_actual),None, eliminar_turno]
    elif perfil_actual == "medico":
        acciones = [None, lambda: mostrar_turnos(usuario_actual, perfil_actual),ver_agenda_diaria_medico]
    try:
